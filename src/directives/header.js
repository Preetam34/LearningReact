      ...
      <li className="icons dropdown">
        ...
        <div className="drop-down dropdown-profile animated fadeIn dropdown-menu">
          <div className="dropdown-content-body">
            <ul>
              <li>
              <Link to={`${config.baseUrl}profile`}><button><i className="icon-user" /> <span>Profile</span></button></Link>
              </li>
              <li>
                <a href="javascript:void()">
              ...
              <li><Link to={`${config.baseUrl}login`}> <button><i className="icon-key" /> <span>Logout</span></button></Link></li>
            </ul>
          </div>
        </div>
      </li>
